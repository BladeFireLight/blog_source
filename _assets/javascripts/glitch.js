...
$(document).ready(function(){
  ...
  $("#js-404-typed").typed({
    strings: ["<span class='glitch__title'>These are not the scripts your looking for ^500</span> <span class='br'></span> Sorry, but the page you were trying to view has moved or does not exist -- perhaps you can <a href='/sitemap/' title='Sitemap'>find it here</a> or by searching below."],
    contentType: "html",
    startDelay: 0,
    backDelay: 3000,
    callback: function(){
